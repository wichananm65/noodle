<template>
  <div>
    <h1>Create Noodle</h1>
    <form v-on:submit.prevent="createNoodle">
      <p>
        brand:
      ...
      <p>
        production:
        <input type="text" v-model="noodle.production" />
      </p>
      <p>
        status:
        <input type="text" v-model="noodle.status" />
      </p>
      <p>
        <button type="submit">create noodle</button>
      </p>
    </form>
  </div>
</template>
